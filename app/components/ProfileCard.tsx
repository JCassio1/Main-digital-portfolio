      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img
                className='absolute inset-0 h-full w-full object-contain object-bottom will-change-transform transition-transform duration-[120ms] ease-out'
                src={avatarUrl}
            ...
            >
              <div
                className='absolute left-4 right-4 flex flex-col rounded-xl border border-white/15 bg-black/55 px-3 py-2 shadow-lg backdrop-blur-sm'
              ...
              >
                ...
                <p
                  className='mx-auto w-min whitespace-nowrap font-semibold text-white/90'
                  style={{
                    position: 'relative',
                    top: '-12px',
                    fontSize: '16px',
